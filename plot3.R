## Exploratory Data Analysis: Class 4 Project1 - Plot 3
...
## Subset the data, which will narrow it down to 2880 obs. of 9 variables
        ...
        ##extract the day of week from Date
        ##WeekDay_temp<-ymd(SubsetData$Date, tz="America/Phoenix")
        ##WeekDay<-wday(WeekDay_temp, label=TRUE)
